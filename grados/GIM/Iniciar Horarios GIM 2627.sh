#!/bin/bash
# ─────────────────────────────────────────────
#  Gestor de Horarios GIM — UPCT  (Curso 2026-2027)
...
GRADO_DIR="$(pwd)"
ROOT_DIR="$(cd ../.. && pwd)"
DB_NAME="horarios_2627.db"
TMP_DB="/tmp/horarios_gim_2627.db"
...
echo "🚀  Arrancando servidor de horarios GIM (curso 2026-2027)..."
...
echo "  Grado: GIM   Curso: 2026-2027"
